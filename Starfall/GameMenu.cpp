...
GameMenu::GameMenu(std::string menuFileName, int& windowWidth, int& windowHeight)
{
	...
	if (inputFile.is_open())
	{
		...
		if (inputFile.good())
		{
			...
			//set position
			m_logoSprite.setPosition(m_backgroundRect.left + m_backgroundRect.width / 2, (m_backgroundRect.top + m_logoTexture.getSize().y));
		}
...
int GameMenu::update(sf::Time& elapsedTime)
{
